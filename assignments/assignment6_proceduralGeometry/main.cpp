...
int main() {
	...
	//Create Plane
	ew::MeshData planeMeshData = patchwork::createPlane(5.0f, 5.0f, 5);
	ew::Mesh planeMesh(planeMeshData);

	//Initialize transforms
	ew::Transform planeTransform;
	planeTransform.position = ew::Vec3(1.0f, 0.0f, 10.0f);

	//Create Cylinder
	ew::MeshData cylinderMeshData = patchwork::createCylinder(5.0f, 5.0f, 6);
	ew::Mesh cylinderMesh(cylinderMeshData);

	//Initialize transforms
	ew::Transform cylinderTransform;
	cylinderTransform.position = ew::Vec3(-5.0f, 0.0f, 0.0f);

	//Create Sphere
	ew::MeshData sphereMeshData = patchwork::createSphere(5.0f, 6);
	ew::Mesh sphereMesh(sphereMeshData);

	//Initialize transforms
	ew::Transform sphereTransform;
	sphereTransform.position = ew::Vec3(10.0f, 0.0f, 0.0f);
